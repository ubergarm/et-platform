...
namespace dnn_lib {
  ...
  {
    dnn_lib::inlining::fwdLibFullyConnectedInst<Int8QTy,Int8QTy,Int8QTy>(out0, in0, in1, in2, flags, minionOffset, assignedMinions);
  }
  ...
  {
    dnn_lib::inlining::fwdLibFullyConnectedInstThreaded<Int8QTy,Int8QTy,Int8QTy>(out0, in0, in1, in2, flags, minionOffset, assignedMinions);
  }
  ...
  {
    dnn_lib::inlining::fwdLibFullyConnectedInstVectorized<Int8QTy,Int8QTy,Int8QTy>(out0, in0, in1, in2, flags, minionOffset, assignedMinions);
  }
