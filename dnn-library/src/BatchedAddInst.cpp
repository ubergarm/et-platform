...
namespace dnn_lib {
  ...
  {
    dnn_lib::inlining::fwdLibBatchedAddInst<FloatTy,FloatTy,FloatTy>(out0, in0, in1, flags, minionOffset, assignedMinions);
  }
  ...
  {
    dnn_lib::inlining::fwdLibBatchedAddInstThreaded<FloatTy,FloatTy,FloatTy>(out0, in0, in1, flags, minionOffset, assignedMinions);
  }
