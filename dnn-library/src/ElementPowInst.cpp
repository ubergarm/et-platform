...
namespace dnn_lib {
  ...
  {
    dnn_lib::inlining::fwdLibElementPowInstThreaded<FloatTy,FloatTy,FloatTy>(out0, in0, in1, flags, minionOffset, assignedMinions);
  }
  ...
  {
    dnn_lib::inlining::fwdLibElementPowInstVectorized<FloatTy,FloatTy,FloatTy>(out0, in0, in1, flags, minionOffset, assignedMinions);
  }
