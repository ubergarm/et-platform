...
namespace dnn_lib {
  ...
  {
    dnn_lib::inlining::fwdLibChannelWiseQuantizedConvolutionInst<out0Type, in2Type>(out0, in0, in1, in2, in3, in4, in5, in6, Kernels, Strides, Pads, Group, Dilation, flags, minionOffset, assignedMinions);
  }
