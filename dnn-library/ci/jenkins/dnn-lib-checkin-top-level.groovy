    ...
    stage('WRAPPER') {
      ...
      stages {
        ...
        stage('CLANG_CHECK') {
          steps {
            script {
              if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-clang-tests', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}")) {
                script {
                  def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-clang-tests')
                  build job:
                    'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-clang-tests',
                    propagate: true,
                    parameters: [
                      string(name: 'BRANCH', value: "${SW_PLATFORM_BRANCH}"),
                      string(name: 'COMPONENT_COMMITS', value: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}"),
                      booleanParam(name: "FORCE_CHILD_RETRIGGER", value: "${FORCE_CHILD_RETRIGGER}"),
                      string(name: "SUBMODULE_COMMITS", value: child_submodule_commits),
                      string(name: 'INPUT_TAGS', value: "${env.PIPELINE_TAGS}")
                    ]
        ...
        stage('PARALLEL1') {
          parallel {
            stage('AUTO_CODE_GEN') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-automatic-code-gen-ci', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-automatic-code-gen-ci')
                      build job:
                        'sw-platform/host-sw-integration/pipelines/dnn-lib/dnn-lib-automatic-code-gen-ci',
                        propagate: true,
                        parameters: [
                          string(name: 'BRANCH', value: "${SW_PLATFORM_BRANCH}"),
                          string(name: 'COMPONENT_COMMITS', value: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}"),
            ...
            stage('DNN_LIB_CI') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib-checkin-top-level', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}", JOB_NAME: 'sw-platform/host-sw-integration/pipelines/dnn-lib-checkin-top-level')
                      build job:
            ...
            stage('GLOW_CI') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/glow-integration/glow-checkin-top-level', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}", JOB_NAME: 'sw-platform/glow-integration/glow-checkin-top-level')
                      build job:
            ...
            stage('GLOW_FRONTEND_CI') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", REPO_SSH_URL: 'git@gitlab.esperanto.ai:software/sw-platform.git', JOB_NAME: 'sw-platform/glow-integration/pipelines/glow-test-plan/frontend-etrt-devfw-sysemu', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", REPO_SSH_URL: 'git@gitlab.esperanto.ai:software/sw-platform.git', COMPONENT_COMMITS: "host-software/dnnLibrary:${BRANCH}, ${COMPONENT_COMMITS}", JOB_NAME: 'sw-platform/glow-integration/pipelines/glow-test-plan/frontend-etrt-devfw-sysemu')
                      build job:
