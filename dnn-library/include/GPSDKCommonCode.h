...
#ifndef _GPSDK_COMMON_CODE_H_
#define _GPSDK_COMMON_CODE_H_
...
static inline int global_memcpy(void* dst, const void* src, size_t num_bytes) {
  ...
  bool aligned_ptrs = (reinterpret_cast<uintptr_t>(s) % 32UL == 0) && (reinterpret_cast<uintptr_t>(d) % 32UL == 0);
