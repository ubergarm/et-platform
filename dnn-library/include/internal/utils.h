 ...
 * @param[in] activeMinions The number of minions that is working on the tensor.
 */
inline __attribute__((always_inline)) void getCachelinePartition(unsigned int elementSize, unsigned int numElems,
 ...
 * @param[in] activeMinions The number of minions that is working on the tensor.
 */
inline __attribute__((always_inline)) void getReversedCachelinePartition(unsigned int elementsize,
                                                                         unsigned int ElemsDst, unsigned int& offset,
...
inline __attribute__((always_inline)) bool getOffsets(unsigned int dimNum, unsigned int* coord, offset_t& offset,
 ...
 */
template <typename T>
inline __attribute__((always_inline)) bool getOffsets(unsigned int dimNum, unsigned int* coord, T& offset1, T& offset2,
                                                      const unsigned int* index, const unsigned int* pitch1,
...
/* overloading while sw-2400 and sw-2429 are WIP */
inline __attribute__((always_inline)) bool getOffsets(unsigned int dimNum, unsigned int* coord, unsigned int& offset1,
...
getOffsets(unsigned int dimNum, unsigned int* coord, offset_t& offset1, offset_t& offset2, offset_t& offset3,
           offset_t& offset4, const dims_t* index, const pitches_t* pitch1, const pitches_t* pitch2,
...
inline __attribute__((always_inline)) std::pair<int, int> getLanesResFromNElements(unsigned int numofelements) {
  int lanes = 0, res = 0;
