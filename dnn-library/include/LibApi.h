 ...
 ////////////////////////////////////////////////////////////////////////////////
  ...
  static constexpr auto instrConfigTable = std::experimental::make_array(
    ...
    instrConfig{
      ...
      // L1 states per impl
      {{{operandState::invalid, operandState::invalid}, {operandState::clean, operandState::clean}}},
      // L2 states per impl
      {{{operandState::invalid, operandState::invalid}, {operandState::clean, operandState::clean}}},
      // CB states per impl
      {{{operandState::invalid, operandState::invalid}, {operandState::dirty, operandState::clean}}},
      {0x0, 0x0} // evict available mask
    },
    /**** ET_crossentropyloss ****/
    instrConfig{
