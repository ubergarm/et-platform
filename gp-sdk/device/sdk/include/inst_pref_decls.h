...
// Declaring registers: a total of 4
	...
	"la  %[self_ptr], __start_testOperator_w_pref_inst_pref_sect\n"
...
// Declaring registers: a total of 5
	__asm__ __volatile__ (
	"la  %[self_ptr], __start_testOperator_w_pref_inst_pref_sect\n"
	"la  %[self_ptr_end], __stop_testOperator_w_pref_inst_pref_sect\n"
      : 
        [self_ptr] "=r" (self_ptr),
...
// Declaring registers: a total of 8
	...
	"la  %[ret_ptr], testOperator_w_pref_return_point\n"
