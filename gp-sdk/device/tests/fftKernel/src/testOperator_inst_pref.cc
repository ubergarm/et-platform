...
// Declaring registers: a total of 15
	...
	"la  %[self_ptr], __start_testOperator_inst_pref_sect+64\n"
	"addi  x3, x1, 0x4 /*4*/ \n"
	"or  x3, x3, %[self_ptr]\n"
	"csrw  prefetch_va /* 0x81f */, x3\n"
	 //Activation prefetch prefetcher (a few lines to prefetch ASAP)
	"addi  x4, x1, 0x4 /*4*/ \n"
	"la  %[act_pref_ptr], __start_testOperator_act_pref_inst_pref_sect\n"
	"or  x3, x4, %[act_pref_ptr]\n"
	"csrw  prefetch_va /* 0x81f */, x3\n"
	 //Compute prefetcher (a few lines to prefetch ASAP)
	"la  %[compute_ptr], __start_testOperator_compute_inst_pref_sect\n"
	...
	"1:\n"
	"la  %[act_pref_size], __stop_testOperator_act_pref_inst_pref_sect\n"
	...
	"1:\n"
	"la  %[compute_size], __stop_testOperator_compute_inst_pref_sect\n"
